<template>
    <div id="home" class="flex-set">
        ...
        <pager page-type="home" :page-size="5" @page-turn="pageTurn(arguments)"/>
    </div>
</template>
...
export default {
    ...
    mounted: function() {
        ...
        this.post_list.push({commentCount:0,description: "哦i饿啊金佛i金额案件覅饿哦i就丰阿",time:"2020-23-21 19:59:19",id:4,bgurl: this.url + '2.jpg\')',title:'faefaefeaga'})
