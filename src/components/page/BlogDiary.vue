<template>
    <div id="diary" class="flex-set">
        <div class="post-box" v-for="(elem, id) in post_list" :key="id">
            ...
            <span class="flex-set post-meta">
                <h3 class="transition-set">
                    <router-link name="router" :to="'/diary/post/' + elem.id.toString()">
                        {{elem.title}}
                    </router-link>
                </h3>
        ...
        <pager page-type="diary" :page-size="5" @page-turn="pageTurn(arguments)"/>
    </div>
</template>
    ...
    methods: {
        pageTurn(vals) {
            ...
            this.$axios
                ...
                .catch(failRespone => {
                    console.log("get diary post failed")
                    return failRespone
                })
        },
    },
    mounted: function() {
        this.post_list.push({description: "哦i饿啊金佛i金额案件faeppjfpeaf覅饿哦i就丰阿",time:"2020-23-21 29:29:29",id:1,bgurl: this.url + '5.jpg\')',title:'faefaefeaga'})
        this.post_list.push({description: "哦i饿啊金佛i金额案件覅饿哦i就丰faeskfpoae阿",time:"2010-03-21 29:29:29",id:2,bgurl: this.url + '4.jpg\')',title:'faefaa'})
        this.post_list.push({description: "哦i饿啊金佛i金dawefaefaefaewfcvegvewgiu合肥ui阿尔回复哈尔u符号二后发我敌后啊回复啊额额案件覅饿哦i就丰faokjfop阿",time:"2020-23-21 19:59:19",id:3,bgurl: this.url + '0.jpg\')',title:'fawfgw哦i发觉我偶发就安排ga'})
        this.post_list.push({description: "哦i饿啊金佛i金额案件覅饿哦i就丰阿",time:"2020-23-21 19:59:19",id:4,bgurl: this.url + '6.jpg\')',title:'faefaefeaga'})
        this.post_list.push({description: "哦i饿啊金faepjfpoeajfkpoaekjf佛i金额案件覅饿哦i就丰阿",time:"2020-23-21 19:59:19",id:5,bgurl: this.url + '3.jpg\')',title:'faefaefeaga'})
        for (let i = 0; i < 15; ++i) {
